...
const commentSchema = z.object({
  ...
  pesan: z.string().min(5, "Komentar minimal 5 karakter"),
});
  ...
  if (submitted) {
    return (
      <div className="rounded-xl bg-primary/10 px-5 py-6 text-center">
        ...
        <p className="mt-2.5 text-sm font-bold text-foreground">Komentar Terkirim!</p>
        <p className="mt-1 text-sm text-muted-foreground">
          Terima kasih, komentar Anda akan tampil setelah disetujui oleh admin.
        </p>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <input
            id="comment-email"
            type="email"
            placeholder="Email Anda (tidak ditampilkan publik)"
            className={cn(inputClass, "mt-1.5")}
